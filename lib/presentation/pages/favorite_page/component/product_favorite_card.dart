...
class FavoProductCard extends StatelessWidget {
  const FavoProductCard({Key? key, required this.index}) : super(key: key);
  final int index;

  @override
  Widget build(BuildContext context) {
    final product = Get.favoriteController.products[index];
